...
//         try {
//             const res = await axios.post("https://backendcrm-vm8o.onrender.com/register", formd);
...
const RegisterPage = () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <input name="name" value={formd.name} onChange={handleChange} placeholder="Name" />
            {errors.name && <span>{errors.name}</span>}
            
            <input name="email" value={formd.email} onChange={handleChange} placeholder="Email" />
            {errors.email && <span>{errors.email}</span>}
            
            <input name="password" type="password" value={formd.password} onChange={handleChange} placeholder="Password" />
